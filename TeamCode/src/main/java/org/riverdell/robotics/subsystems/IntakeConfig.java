...
public class IntakeConfig {
    ...
    public static double observePosition= 0.0;
    public static double grabPosition= 0.2;

    // wrist
    public static double frontPosition= 0.0;
    public static double  backPosition = 0.0;
    public static double  veritcalPosition = 0.25;
    public static double  leftPosition = 0.125;
    public static double  rightPosition = 0.375;
