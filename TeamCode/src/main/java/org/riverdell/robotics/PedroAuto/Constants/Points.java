...
public final class Points {
    ...
    //public static final Point slantStart = new Point(8.0, 100.0, Point.CARTESIAN);
    ...
    public static final Pose slantStartPose = new Pose(slantStart.getX(), slantStart.getY(), 0.0); //Math.PI/2
