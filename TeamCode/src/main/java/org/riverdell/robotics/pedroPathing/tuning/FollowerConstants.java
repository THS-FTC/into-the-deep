...
import org.riverdell.robotics.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.riverdell.robotics.pedroPathing.util.CustomPIDFCoefficients;
...
import org.riverdell.robotics.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 71.376866666;
    private static double yMovement = 50.88255;
    ...
    public static double forwardZeroPowerAcceleration = -37.689716666;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -85.39058;
